...
完成一次配置后，集成会定时更新绑定户号的每日用电量及分时数据、本月累计电量、账户余额，
...
| 最新日谷电量 | kWh | 最新数据日的谷时段用电量 |
| 最新日平电量 | kWh | 最新数据日的平时段用电量 |
| 最新日峰电量 | kWh | 最新数据日的峰时段用电量 |
| 最新日尖电量 | kWh | 最新数据日的尖时段用电量 |
